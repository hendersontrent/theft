...
minmax_scaler <- function(x) {
    .Call('_theft_minmax_scaler', PACKAGE = 'theft', x)
}
...
zscore_scaler <- function(x) {
    .Call('_theft_zscore_scaler', PACKAGE = 'theft', x)
}
...
sigmoid_scaler <- function(x) {
    .Call('_theft_sigmoid_scaler', PACKAGE = 'theft', x)
}
...
robustsigmoid_scaler <- function(x) {
    .Call('_theft_robustsigmoid_scaler', PACKAGE = 'theft', x)
}
...
mean_scaler <- function(x) {
    .Call('_theft_mean_scaler', PACKAGE = 'theft', x)
}
