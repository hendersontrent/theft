#' Fit a mixed-effects Bayesian logistic regression model
#' @import dplyr
#' @importFrom magrittr %>%
#' @import rstan
...
fit_mixed_bayes_glm <- function(data, id_var = NULL, group_var = NULL, iter = 3000, chains = 3, max_treedepth = 15){
  ...
  name_list <- as.vector(colnames(data))
