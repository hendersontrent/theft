...
Users can also supply their own features to `theft` (see the vignette for more).

## Package extensibility

The companion package [`thefttools`](https://github.com/hendersontrent/thefttools) contains an extensive suite of functions for analysing, interpreting, and visualising time-series features calculated from `theft`.
