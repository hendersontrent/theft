...
The package also contains a suite of tools for automatic normalisation of extracted feature vectors, low dimensional projections, data matrix visualisations, top feature classification analyses, and class discrimination visualisations.
...
This package is an ongoing project with development occurring at a rapid rate. As such, there is no guarantee that all functions operate correctly yet.
