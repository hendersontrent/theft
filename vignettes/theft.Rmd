...
For two-class problems, users can fit either `"t-test"` or `"binomial logistic"` models as string arguments to `test_method`, and for multiclass problems the options are either `"linear svm"` or `"rbf svm"`.
