...
```{r, message = FALSE, warning = FALSE}
plot_low_dimension(feature_matrix, is_normalised = FALSE, id_var = "id", group_var = NULL, method = "RobustSigmoid", low_dim_method = "PCA", plot = TRUE)
```
...
```{r, message = FALSE, warning = FALSE}
plot_low_dimension(feature_matrix, is_normalised = FALSE, id_var = "id", group_var = NULL, method = "RobustSigmoid", low_dim_method = "t-SNE", perplexity = 5, plot = TRUE)
```
