...
Each component is named and can be accessed through regular use of the `$` operator. Here is the feature-feature correlation plot:

```{r, message = FALSE, warning = FALSE, eval = FALSE}
print(outputs$FeatureFeatureCorrelationPlot)
```

<img src="FeatureFeatureCorrelationPlot.png" alt="Feature-feature correlation plot" />
...
<img src="ViolinPlots.png" alt="Violin plots" />
...
<img src="FeatureSetResultsPlot.png" alt="Comparison of classification and balanced classification accuracy for catch22" />
